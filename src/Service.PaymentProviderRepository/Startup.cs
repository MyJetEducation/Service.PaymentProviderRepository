...
using Service.PaymentProviderRepository.Modules;
using Service.PaymentProviderRepository.Postgres;
using Service.PaymentProviderRepository.Services;
using Service.Core.Client.Constants;
using Service.Grpc;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.PaymentProviderRepository
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                endpoints.MapGrpcSchema<PaymentProviderRepositoryService, IPaymentProviderRepositoryService>();
